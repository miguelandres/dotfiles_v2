...
# Sleep the display after 5 minutes while on battery
sudo pmset -b displaysleep 5

# Set machine sleep to 15 mins on power adapter
...
# Make the animation for autohiding faster
...
# Bottom left screen corner → Quick Notes
